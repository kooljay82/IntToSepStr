(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["IntToSepStr"] = factory();
	else
		root["IntToSepStr"] = factory();
})(self, function() {
...
/* harmony export */   "checkIsNumber": () => (/* binding */ checkIsNumber),
/* harmony export */   "toStringOfNumber": () => (/* binding */ toStringOfNumber),
/* harmony export */   "checkIsValidLength": () => (/* binding */ checkIsValidLength),
/* harmony export */   "splitNum": () => (/* binding */ splitNum),
...
var checkIsNumber = function checkIsNumber(num) {
  var _context;

  if (_babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_0___default()(_context = String(num).toLowerCase()).call(_context, 'e') > -1 || isNaN(num)) return false;
  return true;
};
var toStringOfNumber = function toStringOfNumber(num) {
  return checkIsNumber(num) ? "".concat(num) : '';
};
var checkIsValidLength = function checkIsValidLength(num) {
  var strOfNum = toStringOfNumber(num);

  var lengthIsGood = function (len) {
...
var splitNum = function splitNum(num) {
  var validStr = checkIsValidLength(num);
  return validStr.split('');
};
var addSeparator = function addSeparator(num) {
  var unit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 3;
  var sep = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : ',';
  var validArr = splitNum(num);
  ...
  if (unit >= validArr.length) {
    ...
    _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_1___default()(_context2 = _babel_runtime_corejs3_core_js_stable_instance_reverse__WEBPACK_IMPORTED_MODULE_2___default()(validArr).call(validArr)).call(_context2, function (v, i) {
      if (i > 0 && i % unit === 0) {
        var _context3, _context4;

        AddedSepStr = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_3___default()(_context3 = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_3___default()(_context4 = "".concat(v)).call(_context4, sep)).call(_context3, AddedSepStr);
      } else {
        var _context5;

        AddedSepStr = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_3___default()(_context5 = "".concat(v)).call(_context5, AddedSepStr);
      }
    });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (addSeparator);
})();
...
//# sourceMappingURL=int-to-sep-str.js.map